...
├── aplikasi/                 ← perencanaan LMS pendukung (27 dokumen)
└── CHANGELOG.md
```
...
| Aplikasi pendukung | **Perencanaan v0.1** — 27 dokumen ([aplikasi/](aplikasi/README.md)) · [Todo dev](aplikasi/27_Dev_Todo_List_Per_Modul.md) |
