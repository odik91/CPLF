...
| Kode modul CPLF | `XI-S4-P12` |
| Materi pokok | Branch & Kolaborasi |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI4.6 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S4-P12_branch-kolaborasi.md](../../../../../06-modules/kelas-xi/semester-4/XI-S4-P12_branch-kolaborasi.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CXI-T5, CXI-K2 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari overwrite teman → **branch** + merge + atribusi. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P12_branch-kolaborasi.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P12_branch-kolaborasi.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-4/XI-S4-P12_branch-kolaborasi.md)
