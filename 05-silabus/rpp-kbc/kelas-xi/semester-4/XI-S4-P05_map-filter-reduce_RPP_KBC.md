...
| Kode modul CPLF | `XI-S4-P05` |
| Materi pokok | map, filter, reduce |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI4.3 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S4-P05_map-filter-reduce.md](../../../../../06-modules/kelas-xi/semester-4/XI-S4-P05_map-filter-reduce.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CXI-B2, AD |
| Mental model |  |
| Experience / PRJ | [EXP_09 TikTok Feed](../../../07-experience_library/EXP_09_TikTok_Feed.md) |
| **Learning transformation** | Dari tampilkan mentah → **olah data** sebelum UI. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P05_map-filter-reduce.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P05_map-filter-reduce.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-4/XI-S4-P05_map-filter-reduce.md)
