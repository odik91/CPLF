...
| Kode modul CPLF | `XI-S4-P07` |
| Materi pokok | localStorage CRUD |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI4.4 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S4-P07_localstorage-crud.md](../../../../../06-modules/kelas-xi/semester-4/XI-S4-P07_localstorage-crud.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari refresh = hilang → **persistensi lokal** terkendali. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P07_localstorage-crud.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P07_localstorage-crud.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-4/XI-S4-P07_localstorage-crud.md)
