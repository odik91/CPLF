...
| Kode modul CPLF | `XI-S4-P06` |
| Materi pokok | Pipeline Transformasi Data |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI4.3 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S4-P06_pipeline-data.md](../../../../../06-modules/kelas-xi/semester-4/XI-S4-P06_pipeline-data.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari transformasi di UI → **pipeline** terpisah & testable. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P06_pipeline-data.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-4/XI-S4-P06_pipeline-data.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-4/XI-S4-P06_pipeline-data.md)
