...
| Kode modul CPLF | `XI-S3-P07` |
| Materi pokok | Struktur Data Nested |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI3.4 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S3-P07_struktur-data-nested.md](../../../../../06-modules/kelas-xi/semester-3/XI-S3-P07_struktur-data-nested.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CXI-B2 |
| Mental model |  |
| Experience / PRJ | [EXP_07 Perpustakaan](../../../07-experience_library/EXP_07_Perpustakaan.md) (spiral) |
| **Learning transformation** | Dari variabel global bercecer → **skema data** array of object. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P07_struktur-data-nested.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P07_struktur-data-nested.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-3/XI-S3-P07_struktur-data-nested.md)
