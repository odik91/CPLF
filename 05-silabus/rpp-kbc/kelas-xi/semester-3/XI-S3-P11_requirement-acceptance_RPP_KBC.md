...
| Kode modul CPLF | `XI-S3-P11` |
| Materi pokok | Requirement & Acceptance Criteria |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI3.6 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S3-P11_requirement-acceptance.md](../../../../../06-modules/kelas-xi/semester-3/XI-S3-P11_requirement-acceptance.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CXI-K1 |
| Mental model |  |
| Experience / PRJ | [EXP_02 Gambar Rumah](../../../07-experience_library/EXP_02_Gambar_Rumah.md) (spiral) |
| **Learning transformation** | Dari “bikin bagus” → **requirement testable** dengan checkbox. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P11_requirement-acceptance.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P11_requirement-acceptance.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-3/XI-S3-P11_requirement-acceptance.md)
