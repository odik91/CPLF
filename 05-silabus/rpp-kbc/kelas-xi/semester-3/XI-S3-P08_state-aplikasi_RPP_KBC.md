...
| Kode modul CPLF | `XI-S3-P08` |
| Materi pokok | State Aplikasi di Memori |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI3.4 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S3-P08_state-aplikasi.md](../../../../../06-modules/kelas-xi/semester-3/XI-S3-P08_state-aplikasi.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari CRUD acak → **single source of truth** di memori. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P08_state-aplikasi.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P08_state-aplikasi.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-3/XI-S3-P08_state-aplikasi.md)
