...
| Kode modul CPLF | `XI-S3-P02` |
| Materi pokok | Blueprint & State Diagram |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XI3.1 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XI-S3-P02_blueprint-state.md](../../../../../06-modules/kelas-xi/semester-3/XI-S3-P02_blueprint-state.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CXI-B1 |
| Mental model | MM-11, MM-19 |
| Experience / PRJ | — |
| **Learning transformation** | Dari diagram bebas → **blueprint** yang bisa diuji tim. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P02_blueprint-state.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xi/semester-3/XI-S3-P02_blueprint-state.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xi/semester-3/XI-S3-P02_blueprint-state.md)
