...
| Kode modul CPLF | `XII-S6-P09` |
| Materi pokok | Project Nilai Build 1 |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XII6.6 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XII-S6-P09_project-nilai-build-1.md](../../../../../06-modules/kelas-xii/semester-6/XII-S6-P09_project-nilai-build-1.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari rencana → **bukti** wawancara pengguna + fondasi teknis. |
...
| Field | Isi |
|-------|-----|
| **Panca Cinta utama** | Allah · Sesama · Bangsa |
...
| **Kait operasional** | AI/CV moderat, jujur, dan manfaat komunitas MA. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS Al-Isra 17:36 · QS An-Nisa 4:58 |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xii/semester-6/XII-S6-P09_project-nilai-build-1.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xii/semester-6/XII-S6-P09_project-nilai-build-1.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xii/semester-6/XII-S6-P09_project-nilai-build-1.md)
