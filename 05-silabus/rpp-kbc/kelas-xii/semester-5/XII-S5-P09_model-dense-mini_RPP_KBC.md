...
| Kode modul CPLF | `XII-S5-P09` |
| Materi pokok | Model Dense Mini |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XII5.6 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XII-S5-P09_model-dense-mini.md](../../../../../06-modules/kelas-xii/semester-5/XII-S5-P09_model-dense-mini.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari tutorial copy → **model sendiri** pada dataset P03. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P09_model-dense-mini.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P09_model-dense-mini.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xii/semester-5/XII-S5-P09_model-dense-mini.md)
