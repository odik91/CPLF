...
| Pertemuan ke- | Pertemuan 15/18 |
| Kode modul CPLF | `XII-S5-P15` |
| Materi pokok | Membaca Metrik Model |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XII5.7 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XII-S5-P15_membaca-metrik-model.md](../../../../../06-modules/kelas-xii/semester-5/XII-S5-P15_membaca-metrik-model.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CXII-B2 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari angka di layar → **interpretasi** untuk pengguna non-teknis. |
...
| **Kait operasional** | Kickoff project — janji tim & proses jujur. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P15_membaca-metrik-model.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P15_membaca-metrik-model.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xii/semester-5/XII-S5-P15_membaca-metrik-model.md)
