...
| Pertemuan ke- | Pertemuan 16/18 |
| Kode modul CPLF | `XII-S5-P16` |
| Materi pokok | Peer Review S5 |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XII5.8 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XII-S5-P16_peer-review-s5.md](../../../../../06-modules/kelas-xii/semester-5/XII-S5-P16_peer-review-s5.md) |
...
| **Kait operasional** | Peer review model — kritik metrik/asumsi, bukan mengejek teman. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS Al-Hujurat 49:10 · QS Al-Hujurat 49:11 |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P16_peer-review-s5.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P16_peer-review-s5.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xii/semester-5/XII-S5-P16_peer-review-s5.md)
