...
| Kelas / Semester | Kelas XII / Semester 5 |
| Pertemuan ke- | Pertemuan 07/18 |
| Kode modul CPLF | `XII-S5-P07` |
| Materi pokok | TF.js Tensor Dasar |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | XII5.5 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [XII-S5-P07_tfjs-tensor-dasar.md](../../../../../06-modules/kelas-xii/semester-5/XII-S5-P07_tfjs-tensor-dasar.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CXII-T2 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari teori shape → **`tf.tensor`** di browser. |
...
| Field | Isi |
|-------|-----|
| **Panca Cinta utama** | Sesama · Lingkungan |
...
| **Kait operasional** | Data & model — keadilan dan dampak ke sesama. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS Al-Maidah 5:8 |
...
| Field | Isi |
|-------|-----|
| **BRG pertemuan ini** | - **BRG-08** — [RPP pendukung tidak terpisah; materi](../06-modules/materi-ajar/jalur-kelanjutan/BRG-08_guru.md) |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P07_tfjs-tensor-dasar.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-xii/semester-5/XII-S5-P07_tfjs-tensor-dasar.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-xii/semester-5/XII-S5-P07_tfjs-tensor-dasar.md)
