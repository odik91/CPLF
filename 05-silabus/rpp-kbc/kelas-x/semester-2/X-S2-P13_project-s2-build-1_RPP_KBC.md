...
| Pertemuan ke- | Pertemuan 13/18 |
| Kode modul CPLF | `X-S2-P13` |
| Materi pokok | Project S2 Build (1) |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.7 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P13_project-s2-build-1.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P13_project-s2-build-1.md) |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P13_project-s2-build-1.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P13_project-s2-build-1.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P13_project-s2-build-1.md)
