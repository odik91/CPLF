...
## X-S2-P10 — Object, State & CRUD Mini
...
| Pertemuan ke- | Pertemuan 10/18 |
| Kode modul CPLF | `X-S2-P10` |
| Materi pokok | Object, State & CRUD Mini |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.6 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P10_object-state-crud.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P10_object-state-crud.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T2 |
| Mental model |  |
| Experience / PRJ | [EXP_07 Perpustakaan](../../07-experience_library/EXP_07_Perpustakaan.md) |
| **Learning transformation** | Dari “data dari mana?” → **state object** + operasi tambah/ubah/hapus. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P10_object-state-crud.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P10_object-state-crud.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P10_object-state-crud.md)
