...
| Kode modul CPLF | `X-S2-P07` |
| Materi pokok | Form & Validasi (Konsep) |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.4 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P07_form-validasi.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P07_form-validasi.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T3, CX-B4 |
| Mental model |  |
| Experience / PRJ | [EXP_04 ATM](../../07-experience_library/EXP_04_ATM.md) (spiral) |
| **Learning transformation** | Dari “input diterima mentah” → **validasi sebelum proses**. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P07_form-validasi.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P07_form-validasi.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P07_form-validasi.md)
