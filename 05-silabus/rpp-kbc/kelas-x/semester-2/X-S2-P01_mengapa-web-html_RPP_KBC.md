...
| Pertemuan ke- | Pertemuan 01/18 |
| Kode modul CPLF | `X-S2-P01` |
| Materi pokok | Mengapa Web? HTML Struktur |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.1 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P01_mengapa-web-html.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P01_mengapa-web-html.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T1 |
| Mental model | MM-16 |
| Experience / PRJ | — |
| **Learning transformation** | Dari “web = hafalan tag” → **halaman sebagai representasi pikiran terstruktur**. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P01_mengapa-web-html.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P01_mengapa-web-html.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P01_mengapa-web-html.md)
