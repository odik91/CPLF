...
| Pertemuan ke- | Pertemuan 02/18 |
| Kode modul CPLF | `X-S2-P02` |
| Materi pokok | HTML Semantik & Konten MA |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.1 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P02_html-semantik-ma.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P02_html-semantik-ma.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T1, CX-K1 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari “tag sembarang” → **semantik** (`header`, `main`, `section`, `footer`). |
...
| Field | Isi |
|-------|-----|
| **Panca Cinta utama** | Sesama · ihsan |
...
| **Kait operasional** | HTML semantik = ihsan kepada pengguna (mis. screen reader). |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS An-Nahl 16:90 · HR Muslim (ihsan) |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P02_html-semantik-ma.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P02_html-semantik-ma.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P02_html-semantik-ma.md)
