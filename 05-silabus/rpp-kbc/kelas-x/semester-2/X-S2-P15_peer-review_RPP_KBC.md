...
| Kode modul CPLF | `X-S2-P15` |
| Materi pokok | Peer Review Project S2 |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.7 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P15_peer-review.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P15_peer-review.md) |
...
| **Kait operasional** | Kritik kode/asumsi, bukan personal. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS Al-Hujurat 49:10 · HR Bukhari/Muslim (kasih saudara) |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P15_peer-review.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P15_peer-review.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P15_peer-review.md)
