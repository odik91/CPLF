...
## X-S2-P06 — Event & Interaksi Pengguna
...
| Kode modul CPLF | `X-S2-P06` |
| Materi pokok | Event & Interaksi Pengguna |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.3 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P06_event-interaksi.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P06_event-interaksi.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T3 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari “satu klik” → **model interaksi** (input, toggle, counter). |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P06_event-interaksi.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P06_event-interaksi.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P06_event-interaksi.md)
