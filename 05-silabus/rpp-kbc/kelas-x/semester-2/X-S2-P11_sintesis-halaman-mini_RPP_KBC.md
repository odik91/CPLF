...
## X-S2-P11 — Sintesis Halaman Mini
...
| Pertemuan ke- | Pertemuan 11/18 |
| Kode modul CPLF | `X-S2-P11` |
| Materi pokok | Sintesis Halaman Mini |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.5–2.6 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P11_sintesis-halaman-mini.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P11_sintesis-halaman-mini.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T1–T3 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Menyatukan HTML + CSS + JS + data **dalam satu halaman koheren**. |
...
| **Kait operasional** | Web & kolaborasi — manfaatkan untuk sesama. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS An-Nahl 16:90 (adl wa ihsan) |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P11_sintesis-halaman-mini.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P11_sintesis-halaman-mini.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P11_sintesis-halaman-mini.md)
