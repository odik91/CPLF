...
| Pertemuan ke- | Pertemuan 08/18 |
| Kode modul CPLF | `X-S2-P08` |
| Materi pokok | Validasi JavaScript & Pesan Error |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.4 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P08_validasi-js-pesan.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P08_validasi-js-pesan.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T3, CX-K1 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari “alert generik” → **validasi custom + UX jelas**. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P08_validasi-js-pesan.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P08_validasi-js-pesan.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P08_validasi-js-pesan.md)
