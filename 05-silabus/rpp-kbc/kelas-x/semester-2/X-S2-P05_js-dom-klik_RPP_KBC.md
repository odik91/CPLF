...
| Kode modul CPLF | `X-S2-P05` |
| Materi pokok | JavaScript & DOM (Klik) |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.3 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P05_js-dom-klik.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P05_js-dom-klik.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T2, CX-T3 |
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari “halaman mati” → **perilaku** lewat DOM + event. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P05_js-dom-klik.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P05_js-dom-klik.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P05_js-dom-klik.md)
