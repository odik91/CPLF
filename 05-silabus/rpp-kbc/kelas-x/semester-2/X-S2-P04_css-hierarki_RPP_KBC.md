...
| Kode modul CPLF | `X-S2-P04` |
| Materi pokok | CSS Hierarki & Keterbacaan |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.2 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P04_css-hierarki.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P04_css-hierarki.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari “styling inline acak” → **hierarki visual** (heading, kontras, spacing). |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P04_css-hierarki.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P04_css-hierarki.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P04_css-hierarki.md)
