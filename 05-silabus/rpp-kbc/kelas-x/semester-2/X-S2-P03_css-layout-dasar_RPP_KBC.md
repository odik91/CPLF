...
| Kode modul CPLF | `X-S2-P03` |
| Materi pokok | CSS Layout Dasar |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X2.2 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S2-P03_css-layout-dasar.md](../../../../../06-modules/kelas-x/semester-2/X-S2-P03_css-layout-dasar.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | Dari “asal cantik” → **aturan presentasi** yang konsisten. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P03_css-layout-dasar.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-2/X-S2-P03_css-layout-dasar.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-2/X-S2-P03_css-layout-dasar.md)
