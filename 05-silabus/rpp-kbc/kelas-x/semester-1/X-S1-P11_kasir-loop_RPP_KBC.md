...
| Kode modul CPLF | `X-S1-P11` |
| Materi pokok | Kasir & Loop |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X1.6 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S1-P11_kasir-loop.md](../../../../../06-modules/kelas-x/semester-1/X-S1-P11_kasir-loop.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-T3, CX-T2 |
| Mental model | MM-14 |
| Experience / PRJ | [EXP_06 Kasir](../../07-experience_library/EXP_06_Kasir_Minimarket.md) |
| **Learning transformation** | Dari “ulang manual” → **loop** otomatisasi repetisi. |
...
| **Kait operasional** | Loop kasir = hitung dan catat dengan jujur (tidak curang takaran). |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P11_kasir-loop.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P11_kasir-loop.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-1/X-S1-P11_kasir-loop.md)
