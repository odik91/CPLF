...
| Pertemuan ke- | Pertemuan 06/18 |
| Kode modul CPLF | `X-S1-P06` |
| Materi pokok | Gambar Rumah & Requirement |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X1.3 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S1-P06_gambar-rumah-requirement.md](../../../../../06-modules/kelas-x/semester-1/X-S1-P06_gambar-rumah-requirement.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-B1, CX-K1 |
| Mental model | MM-23, MM-01 |
| Experience / PRJ | [EXP_02](../../07-experience_library/EXP_02_Gambar_Rumah.md) · varian [A/B/C](../../07-experience_library/EXP_02_Gambar_Rumah.md#varian-rotasi-kasus-beda-trap-sama) |
| **Learning transformation** | Dari “instruksi sama = hasil sama” → “requirement harus spesifik & testable.” |
...
| Field | Isi |
|-------|-----|
| **Panca Cinta utama** | Sesama · amanah |
...
| **Kait operasional** | Requirement jelas = janji yang bisa dipegang tim & pengguna. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P06_gambar-rumah-requirement.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P06_gambar-rumah-requirement.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-1/X-S1-P06_gambar-rumah-requirement.md)
