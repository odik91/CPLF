...
| Kode modul CPLF | `X-S1-P18` |
| Materi pokok | Showcase S1 & Refleksi Semester |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X1.8 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S1-P18_showcase-refleksi-s1.md](../../../../../06-modules/kelas-x/semester-1/X-S1-P18_showcase-refleksi-s1.md) |
...
| Mental model |  |
| Experience / PRJ | — |
| **Learning transformation** | _(lihat modul)_ |
...
| **Kait operasional** | Refleksi capability, bukan pamer ego. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS Ali Imran 3:190–191 |
...
_(Salin timeline dari modul acuan.)_
...
|-------|------|------------------|
| — | Opening | Lihat timeline Blok E |

**Kegiatan inti**

| Menit | Fase | Aktivitas siswa |
|-------|------|------------------|
| — | Inti CPLF | Experience → Practice |

**Kegiatan penutup**

| Menit | Fase | Aktivitas siswa |
|-------|------|------------------|
| — | Reflect / Exit | Lihat timeline Blok E |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P18_showcase-refleksi-s1.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P18_showcase-refleksi-s1.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-1/X-S1-P18_showcase-refleksi-s1.md)
