...
| Pertemuan ke- | Pertemuan 05/18 |
| Kode modul CPLF | `X-S1-P05` |
| Materi pokok | Flowchart & Pseudocode |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X1.2 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S1-P05_flowchart-pseudocode.md](../../../../../06-modules/kelas-x/semester-1/X-S1-P05_flowchart-pseudocode.md) |
...
|-------|-----|
| Elemen CP (anchor) |  |
| Capability CPLF | CX-B2, CX-T2 |
| Mental model | MM-12, MM-15 |
| Experience / PRJ | — |
| **Learning transformation** | Dari “algoritma di kepala” → “representasi visual & teks yang bisa diuji orang lain.” |
...
| Field | Isi |
|-------|-----|
| **Panca Cinta utama** | Allah · ilmu terstruktur |
...
| **Kait operasional** | Flowchart = urutan berpikir sebelum kode. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS Al-Alaq 96:1–5 |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P05_flowchart-pseudocode.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P05_flowchart-pseudocode.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-1/X-S1-P05_flowchart-pseudocode.md)
