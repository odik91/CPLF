...
| Kode modul CPLF | `X-S1-P16` |
| Materi pokok | Project S1 Build (1) |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X1.8 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S1-P16_project-s1-build-1.md](../../../../../06-modules/kelas-x/semester-1/X-S1-P16_project-s1-build-1.md) |
...
| **Kait operasional** | Build iteratif — amanah waktu & kualitas kelompok. |

## Blok D — Dalil & refleksi (koordinasi guru agama)

| Field | Isi |
|-------|-----|
| **Dalil Al-Qur’an / Hadits (usulan)** | QS An-Nisa 4:58 · QS Al-Asr 103 |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P16_project-s1-build-1.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P16_project-s1-build-1.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-1/X-S1-P16_project-s1-build-1.md)
