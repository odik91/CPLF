...
## X-S1-P17 — Project S1 Build (2) + Peer Review
...
| Pertemuan ke- | Pertemuan 17/18 |
| Kode modul CPLF | `X-S1-P17` |
| Materi pokok | Project S1 Build (2) + Peer Review |
| Alokasi waktu | 2 JP = 90 menit |
| Unit silabus | X1.8 |
| Model pembelajaran CPLF | Experience → Trap → Clarify → Concept → Practice → Reflect → Transfer |
| Modul acuan | [X-S1-P17_project-s1-build-2.md](../../../../../06-modules/kelas-x/semester-1/X-S1-P17_project-s1-build-2.md) |
...
| **Kait operasional** | Review/spiral — renungkan apa yang sudah dikuasai. |
...
- [Handout siswa](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P17_project-s1-build-2.md_siswa.md)
- [Materi guru lengkap](../../../../../06-modules/materi-ajar/kelas-x/semester-1/X-S1-P17_project-s1-build-2.md_guru.md)
- [Materi pendukung guru](../../../../../06-modules/materi-pendukung/kelas-x/semester-1/X-S1-P17_project-s1-build-2.md)
