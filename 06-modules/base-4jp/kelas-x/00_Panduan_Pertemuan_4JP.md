...
```text
~2 JP: paham & alami
~2 JP: kerjakan di keyboard (materi yang sama)
```

### Bridging

Materi yang dulu 2 pertemuan terpisah di mode 2JP → **satu pertemuan 4JP** (teori + praktik digabung), kecuali beban kognitif terlalu tinggi (lalu pecah sadar-sadar).
