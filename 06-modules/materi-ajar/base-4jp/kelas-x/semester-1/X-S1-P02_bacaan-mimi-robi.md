...
> Pengayaan 4JP: setelah literasi, catat hasil di halaman HTML sederhana (`cari.html`) — bukan sekadar worksheet kertas.
...
### Pengayaan 4JP — catat di halaman

Di jalur 4JP, worksheet digabung ke keyboard: tulis ulang pertanyaan, 3 keyword, fakta, dan 2 sumber di `cari.html`. Bukan biar cantik — biar jejak berpikirmu kebaca.
