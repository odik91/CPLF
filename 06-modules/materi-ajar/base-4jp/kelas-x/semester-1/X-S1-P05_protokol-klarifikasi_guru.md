# Materi Guru Lengkap — X-S1-P05 (Base 4JP)

**Handout siswa (bagikan):** [X-S1-P05_protokol-klarifikasi_siswa.md](./X-S1-P05_protokol-klarifikasi_siswa.md)

**Bacaan pendamping siswa:** [X-S1-P05_bacaan-mimi-robi.md](./X-S1-P05_bacaan-mimi-robi.md)

**Modul:** [X-S1-P05_protokol-klarifikasi.md](../../../base-4jp/kelas-x/semester-1/X-S1-P05_protokol-klarifikasi.md)
...
| Capability | CX-B4 |
| MM | MM-00, MM-22 |
| EXP | [EXP_10](../../../../07-experience_library/EXP_10_ChatGPT_Salah.md) |
| Pecah beban | Algoritma ROBI penuh → **P06** |
...
AI bodoh **atau** AI selalu benar → ganti dengan rantai klarifikasi.
...
I do di papan: isi Klaim + Alasan saja (think-aloud).
We do: kelas usul 1 Bukti yang bisa diuji.
Belum debat panjang.

[2 — Experience 25–50]
Baca jawaban AI kalimat 1 — jeda — "Meyakinkan? Ada bukti?"
Lanjut kalimat berikutnya. Seperti baca kode baris demi baris.
Siswa prediksi sebelum kamu lanjut.

[3 — Trap 50–65]
"AI salah. Siapa yang salah?"
Debat 3–5 menit. Jangan vonis. Catat opsi: prompt / kita / model / kurang cek.
...
[9 — Exit 165–180]
"Share ke WA tanpa cek = solusi prematur versi chat."
Exit ticket + preview P06: instruksi harus eksplisit (algoritma).
```
...
**Panca cinta:** Ilmu · tabayyun  
**Dalil (validasi tim agama):** QS Al-Hujurat 49:6 · QS Al-Isra 17:36  
**Kait:** Jangan terima/tolak klaim sebelum klarifikasi.
